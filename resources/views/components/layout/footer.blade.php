<div class="bg-gray-950 px-4 pb-8 pt-12 text-gray-200 sm:px-6 md:px-8 lg:px-36 lg:pb-8 lg:pt-40">
  <div class="lg:gap-30 flex flex-col gap-10 md:gap-12 lg:flex-row">
    ...
    <div class="flex flex-1 flex-col gap-4 sm:gap-6">
      ...
      <a href="#" target="_blank" class="text-sm text-gray-400 transition-colors hover:text-gray-200">Blog</a>
      <a href="#" target="_blank" class="text-sm text-gray-400 transition-colors hover:text-gray-200">Hewan</a>
      <a href="{{ route('gallery.index') }}" target="_blank"
        class="text-sm text-gray-400 transition-colors hover:text-gray-200">Galeri</a>
      <a href="#" target="_blank"
        class="text-sm text-gray-400 transition-colors hover:text-gray-200">Testimonial</a>
    </div>

    <div class="flex flex-1 flex-col gap-4 sm:gap-6">
      <p class="text-base font-semibold sm:text-lg">Privacy</p>
      <a href="#" target="_blank" class="text-sm text-gray-400 transition-colors hover:text-gray-200">Karir</a>
      <a href="{{ route('about') }}" target="_blank"
        class="text-sm text-gray-400 transition-colors hover:text-gray-200">Tentang Kami</a>
      <a href="{{ route('contact.index') }}" target="_blank"
        class="text-sm text-gray-400 transition-colors hover:text-gray-200">Kontak Kami</a>
      <a href="#" target="_blank" class="text-sm text-gray-400 transition-colors hover:text-gray-200">Servis</a>
    </div>
    ...
    <div class="lg:flex-2 flex flex-1 flex-col gap-4 sm:gap-6">
      ...
      <a href="mailto:{{ Str::remove(' ', $contactInfo->email) }}"
        class="align-center flex items-center gap-3 text-sm text-gray-400 transition-colors hover:text-gray-200 sm:gap-4"
        target="_blank">
