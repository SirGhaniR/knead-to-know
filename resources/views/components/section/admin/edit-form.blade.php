...
@if ($type == 'news')
  <div class="mt-14 p-4 sm:p-6 lg:ml-auto lg:w-4/5 lg:p-8">
    <div class="w-full">
      <div class="bg-neutral-primary-soft border-default shadow-xs border p-4 sm:p-6 md:p-8">
        <p class="mb-6 text-xl font-bold sm:text-2xl">Edit Berita</p>
        <x-ui.error />
...
@elseif($type == 'gallery')
  <div class="mt-14 p-4 sm:p-6 lg:ml-auto lg:w-4/5 lg:p-8">
    <div class="w-full">
      <div class="bg-neutral-primary-soft border-default shadow-xs border p-4 sm:p-6 md:p-8">
        <p class="mb-6 text-xl font-bold sm:text-2xl">Edit Foto</p>
        <x-ui.error />
