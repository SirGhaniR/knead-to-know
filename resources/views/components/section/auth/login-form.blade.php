    ...
    <form action="{{ url('/login') }}" method="post">
      ...
      <div class="mb-4 flex flex-col gap-3">
        <x-ui.input name="email" id="email" placeholder="Email" value="{{ old('email') }}"
          class="rounded-none! px-4! py-3! outline-gray-500! sm:px-8! sm:py-4!" data-aos="fade-right"
      ...
      <button type="submit" class="w-full bg-gray-900 p-3 text-center font-bold text-gray-200 hover:opacity-90 sm:p-4"
